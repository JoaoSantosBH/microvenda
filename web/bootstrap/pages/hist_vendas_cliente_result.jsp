...
<html lang="en">
    ...
    <body> 
        <%
            ...
            String idCLiente = request.getParameter("cl");
            if(idCLiente == null){idCLiente="0";}
            String idUser = request.getParameter("us");
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Vendas do Cliente </h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">
                            <% if(Codmsg.equals("4")){%><script>window.alert('Ocorreu um erro! Tente novamente mais tarde!')</script>
                            <%}%>
                            <!-- VENDAS -->
                            <%
                                List<VendaEntidade> lstV = controle.ControladorVenda.pegarTodasAsVendasPorClienteDoVendedor(Integer.valueOf(idUser), Integer.valueOf(idCLiente));
                                if(lstV.size() == 0 ){%>
                                    
                                    <script>window.alert('Não Encontramos venda Para este Usuário!')</script>
