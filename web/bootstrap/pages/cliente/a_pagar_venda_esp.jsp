...
<html lang="en">
    ...
    <body> 
        <%
            ...
            String idVenda = request.getParameter("idv");
            if (idVenda == null) {
                idVenda = "";
            }
        %>
        ...
        <div id="wrapper">
            ...
            <div id="" style="background-color: #fffff1;">
                ...
                UsuarioEntidade u = ControladorUsuario.pegarUsuarioPeloSeuId(Logado.getIdUsuario());
                                List<AreceberEntidade> ls = ControladorAReceber.pegarListaDeAReceberDeUmaVendaEspecifica(Integer.valueOf(idVenda), Integer.valueOf(Logado.getIdUsuario()));

                                if (ls.size() == 0) {%>
                            <script>window.alert('Esta Compra não possui parcelas a Pagar!')</script>
