                    ...
                    <div class="row">
                        ...
                        <div class="panel-body">
                            ...
                            <%
                                ...
                                EstoqueEntidade e = EstoqueDAO.pegarItemNoEstoque(Integer.valueOf(idEstoque), Logado.getIdUsuario());
                                if(e ==null){
                                    e = new EstoqueEntidade();
                                    e.setIdProduto(0);
                                }
                                String nomeProduto = ProdutoDAO.pegarNomeDoProdutoPeloId(e.getIdProduto(), Logado.getIdUsuario());
                                Boolean eMeuEstoque = EstoqueDAO.verificarSeEstoqueEhDoVendedor(idEstoque, Logado.getIdUsuario());

                            %>

                            <% if (eMeuEstoque) {%>
 <form role="form" name="form_mant_estoq" method="post" action="EditarEstoqueServlet">
<!--                                <fieldset>-->
                                    <h3><%= nomeProduto%></h3>
                                    Limite Minimo definido para este estoque = <%= e.getLimiteInferior()%></br>
                                    Este Item possui em estoque <%= e.getQuantidade()%> unidades</br>
                                    <select name="limite_inferior" id="limite_inferior">                                        
                                        <option value="0" >Selecione o limite minimo</option>

                                        <% for (int i = 1; i <= 30; i++) {%><option value="<%=i%>"><%=i%></option><%}%>
                                    </select>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Quantidade" name="txt_qtd" value="<%= e.getQuantidade()%>" type="number" autofocus>
                                    </div>


                                    <div class="form-group">
                                        <input class="form-control" placeholder="Confirme Quantidade" name="txt_qtd_conf" type="number" value="" >
                                    </div>
                                    ...
                                    <input type="hidden" name="id_estoque" value="<%= idEstoque%>">
                                <!--</fieldset>-->
                                ...
                                <script>window.alert('Estoque do Produto Alterado com Sucesso!')</script>
                            ...
                            <hr>
                            <form action="manter_estoque.jsp">
