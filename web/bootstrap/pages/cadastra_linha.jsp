        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Manter Linha de Produtos</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">

                            <% List<LinhaEntidade> ls = persistencia.LinhaDAO.ListarLinhasCadastradas(Logado.getIdUsuario());%>
                            <form role="form" name="formcriacliente" method="post" action="InsereNovaLinhaProdutosServlet">
                                <fieldset>
                                    <div class="form-group">
                                        <h3>Inserir Linha de Produtos</h3>

                                        <input class="form-control" maxlength="150" placeholder="Nome Da Linha" name="txt_nome_linha" type="text" autofocus>
                                    </div>

                                    <input class="btn btn-lg btn-success btn-block" type="submit" value="Salvar Nova Linha" onclick="return validarCriaLinha()">
                                ...
                                <script>window.alert('Linha Cadastrada com Sucesso!')</script>
                                ...
                                <script>window.alert('Linha Apagada Com sucesso!')</script>

                          
                                <% } else if (Codmsg.equals("6")) {%>

                                <script>window.alert('Existem Produtos cadastrados nesta linha!')</script>
                            ...
                            <form role="form" name="form_editar_linha" method="post" action="PreparaEditaLinhaServlet">

                                <fieldset> 

                                    <div class="form-group">
                                        <h3>Editar Linha</h3>
                                        <label>Selecione a Linha que deseja editar</label>
                                        ...
                                        <input class="btn btn-warning btn-success btn-block" type="submit" value=" Editar Linha de Produtos">
                                ...
                                <form role="form" name="form_excluir_linha" method="post" action="ExcluiLinhaServlet">

                                <fieldset> 

                                    <div class="form-group">
                                        <h3>Excluir Linha</h3>
                                        <label>Selecione a Linha que deseja excluir</label>
                                        <select name="linhas" id="linhas">
                                        ...
                                        <input type="hidden" name="id_usuario" value="<%= Logado.getIdUsuario()%>" >
                                        <input class="btn  btn-danger btn-success btn-block" type="submit" value=" Excluir Linha de Produtos" onclick="return confirm('Tem Certeza que deseja Excluir a Linha? Isso apagará também todos os Pordutos desta Linha !!!')">
                                    </div>
