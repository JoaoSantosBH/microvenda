                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="panel-body">
                            Declare ou Atualize o que Investiu
                            <hr>    
                            <%
                            ...
                            <script>
                                window.alert('Ocorreu um erro, tente novamente mais tarde!<%=Erro%>');
                            </script>                            
                            ...
                            <% }%>
                            <form role="form" name="formCapital" method="post" action="AtualizarInvestimentoServlet">
                                <!--<fieldset>-->
                                <div class="form-group">
                                    <label>Valor Total do Capital Investido - não use virgula, utilize o ponto</label> 
                                    <input class="form-control"  placeholder="<%= i.getValorCapital() %>" name="txt_capital" type="number" autofocus >
                                    Total investido em dinheiro
                                </div>
                                <div class="form-group">
                                    <label>Valor Total Investido em objetos e equipamentos - não use virgula, utilize o ponto</label> 
                                    <input class="form-control"  placeholder="<%= i.getValorInventario() %>" name="txt_inventario" type="number"  >
                                    Total investido bens materiais para o negócio
                                </div>
                                <input type="hidden" name="id_usuario_txt" value="<%= Logado.getIdUsuario()%>">
                                <input class="btn btn-lg btn-success btn-block" type="submit" value="Salvar" onclick="return validarCapital()">
                            </form>
                            <script language="javascript" type="text/javascript">
                                function validarCapital() {
                                    var valor = formCapital.txt_capital.value;
                                    if (valor === "") {
                                        alert('Digite o valor Capital investido');
                                        formCapital.txt_capital.focus();
                                        return false;
                                    }
                                    
                                    var valorI = formCapital.txt_inventario.value;
                                    if (valorI === "") {
                                        alert('Digite o valor Inventário investido');
                                        formCapital.txt_inventario.focus();
                                        return false;
                                    }                                    
                                }
                            </script>
