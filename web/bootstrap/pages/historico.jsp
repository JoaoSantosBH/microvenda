        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Historico de Pedidos</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">
                            ...
                            <%
                                List<PedidoEntidade> lsp = ControladorPedido.listarPedidosInativosDoVendedor(Logado.getIdUsuario());
                                if(lsp.size() == 0 ){
                            %>
                            
                                                        <script>window.alert('Não existem pedidos!')
                           ...
                           <%} else {%>
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    ...
                                    <li> <h3> <%=  item.getNome()%> </h3> - Qtde: <%= item.getQtde()%>  - Valor: R$ <%= item.getValorVenda()%></li>
