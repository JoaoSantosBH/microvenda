        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Rank de Clientes</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">
                            ...
                            <%
                               ArrayList<ClienteRank> lsp = ControladorUsuario.prepararRankingUsuariosPorOrdemDeVendasFeitas(Logado.getIdUsuario().toString());
                                if (lsp.size() == 0) {
                            %>

                            <script>
                                window.alert('Ainda não existe informações aqui!')
                            ...
                            <% int coutn =1; for (ClienteRank cr : lsp) { %>

                            <div class="panel panel-warning">
                                <%  ClienteEntidade cliente = ClienteDAO.pegarClientePeloId(cr.getIdCliente());%>
                                <div class="panel-heading">
                                    <h3> <%= coutn %>º <%= cliente.getNome()%>   </h3>
                                </div>
                                
                                <div class="panel-body">
                                    
                                    <h3>R$ <%= cr.getTotal()%>,00 em compras! </h3> 
