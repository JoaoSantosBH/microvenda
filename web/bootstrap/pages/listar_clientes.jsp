        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Manter Cliente</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">

                            <% List<ClienteEntidade> lst = controle.ControladorCliente.pegarListaDeClientesDoVendedor(Logado.getIdUsuario()); %>
                            <form role="form" method="POST" action="EditarClienteServlet">
                                <div class="form-group">
                                    <h3>Editar Cliente</h3>
                                    <label>Selecione um cliente para editar</label>
                                    <select class="form-control" name="txt_id_cliente">

                                        <%  for (ClienteEntidade c : lst) {%>
...
<hr>
                            <form role="form" method="POST" action="ExcluirClienteServlet">
                                 <div class="form-group">
                                     <h3>Excluir Cliente</h3>
                                    <label>Selecione um cliente para excluir</label>
                                    <select class="form-control" name="txt_id_cliente">
                                ...
                                <button type="submit" class="btn btn-danger" onclick="return confirm('Tem Certeza que deseja Excluir o Cliente? Esta Opcao nao podera ser desfeita!')">Excluir Cliente</button>
                                <input type="hidden" name="id_user" value="<%= Logado.getIdUsuario() %>">

                            </form>
                                <% if (Codmsg.equals("")) {%>

                                <% } else if (Codmsg.equals("1")) {%>
                                <script>window.alert('Cliente Excluido com Sucesso!')</script>
