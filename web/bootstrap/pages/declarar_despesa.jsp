        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Declarar Despesa</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">
                            ...
                            <form role="form" name="formdespesa" method="post" action="DeclararDespesaServlet">
                                <!--<fieldset>-->
                                <div class="form-group">
                                    <input class="form-control" maxlength="45" placeholder="Descricao" name="txt_descricao" type="text" autofocus >
                                </div>
                                ...
                                <div class="form-group">
                                    <input class="form-control" id="02"   placeholder="Valor" name="txt_valor" type="number"  >
                                </div>



                                <input class="btn btn-lg btn-success btn-block" type="submit" value="Salvar" onclick="return validarForm()">
                                ...
                                <script>window.alert('Despesa Cadastrada com Sucesso!')</script>
                            ...
                            <script language="javascript" type="text/javascript">
                                function validarForm() {
                                    var nome = formdespesa.txt_descricao.value;
                                    if (nome === "") {
                                        alert('Digite a descricao');
                                        formdespesa.txt_descricao.focus();
                                        return false;
                                    }
                                    var dia = formdespesa.dia.value;
                                    if (dia === "dia") {
                                        alert('Selecione o dia');
                                        formdespesa.dia.focus();
                                        return false;
                                    }
                                    var mes = formdespesa.mes.value;
                                    if (mes === "mes") {
                                        alert('Selecione o mes');
                                        formdespesa.mes.focus();
                                        return false;
                                    }
                                    var ano = formdespesa.ano.value;
                                    if (ano === "ano") {
                                        alert('Selecione o ano');
                                        formdespesa.ano.focus();
                                        return false;
                                    }
                                    var valor = formdespesa.txt_valor.value;
                                    if (valor === "") {
                                        alert('Digite o valor da despesa');
                                        formdespesa.txt_valor.focus();
                                        return false;
                                    }
