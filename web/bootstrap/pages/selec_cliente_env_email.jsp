                    ...
                    <div class="row">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <form role="form" method="POST" name="emailform" action="EnviarEmailParaCLienteServlet">
                                    
                                        <div class="form-group input-group">
                                            <label>Destinatario</label>
                                            <select class="form-group" name="txt_id_cliente">
                                                <option value="000">selecione o cliente</option>
                                        ...
                                        <input type="hidden" value="<%= Logado.getIdUsuario()%>" name="id_user">
                                        <div class="form-group">
                                ...
                                <script language="javascript" type="text/javascript">
                                    function validarEmail() {
                                        var sele = emailform.txt_id_cliente.value;
                                        var msg = emailform.msg.value;
                                        var titulo = emailform.subject.value;
                                        if (sele === "000") {
                                            alert('Voce deve selecionar um cliente para destinatario!')
                                            emailform.txt_id_cliente.focus();
                                            return false;
                                        } else if (titulo === "") {
