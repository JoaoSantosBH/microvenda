            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <%
                                List<VendaEntidade> lstV = controle.ControladorVenda.pegarVendasDoUsuarioDoMesAtual(Logado.getIdUsuario());
                                int totalV = 0;
                                for (VendaEntidade v : lstV) {
                                    totalV += v.getValor();
                                }
                            %>
                            <h1 class="page-header">Vendas do Mes - R$ <%= totalV %> reais</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">
                            ...
                            <script>window.alert('Não foi feita nehuma venda este mes!')
