        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <% List<DespesaEntidade> ls = ControladorDespesa.pegarTodasAsDespesasDoUsuario(Logado.getIdUsuario());

                            %>
                            <h1 class="page-header">Histórico de despesas </h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">
                            ...
                            <%
                                ...
                                if (ls.size() == 0) {%>
                            <script>window.alert('Nenhuma despesa ate agora!')
