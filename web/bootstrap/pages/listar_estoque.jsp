...
<div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 style="color: #720e9e">Estoque de <%= Logado.getNome() %></h4>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><%= ProdutoDAO.pegarNomeDoProdutoPeloId(e.getIdProduto(), Logado.getIdUsuario()) %></td>
                                            
                                            <% if(e.getQuantidade() < e.getLimiteInferior() || (e.getQuantidade() ==0 && e.getLimiteInferior() ==0 )){%>
