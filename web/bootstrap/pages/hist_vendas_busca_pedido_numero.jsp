                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="panel-body">
                            ...
                            <!-- VENDAS -->
                            <%
                                VendaEntidade venda = controle.ControladorVenda.pegarVendaPeloNumPedido(Long.valueOf(param), Logado.getIdUsuario());
                            ...
                            <div class="panel panel-green">
                                ...
                                <div class="panel-heading">
                                    <div>Venda Nº  [ <%= venda.getNumPedido()%>] Cliente : <%= cliente.getNome() %> </div>
                                                                            <%if(valorParcela!=0){%>
