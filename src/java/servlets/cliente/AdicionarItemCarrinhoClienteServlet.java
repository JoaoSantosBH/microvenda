 ...
 * @author joaosantos
 */
public class AdicionarItemCarrinhoClienteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           int iqtd;
            ...
            if (qtd.equals("")) {
                response.sendRedirect("fazer_pedido.jsp?msg=1");
            } else if (iqtd < 0) {
                ...
                response.sendRedirect("fazer_pedido.jsp");
            } else {
                ProdutoEntidade p = persistencia.ProdutoDAO.pegarProdutoPeloId(Integer.valueOf(id));
                Carrinho car = new Carrinho();
                car.setIdProd(Integer.valueOf(id));
                ...
                if (existe) {
                    ...
                    response.sendRedirect("fazer_pedido.jsp?msg=5");
                } else {
            ...
            Logger.getLogger(AdicionarItemCarrinhoClienteServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
