 ...
 * @author joaosantos
 */
public class FecharPedidoVendaDiretaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (lst == null) {
                response.sendRedirect("lista_orcamento_venda_direta.jsp?msg=2");
            } else {
...
//            numPedido += "L";
                ...
                response.sendRedirect("inicia_venda.jsp?idPedido=" + p.getIdPedido());
            }
