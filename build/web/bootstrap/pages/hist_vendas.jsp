        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Historico de Vendas</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">
                            ...
                            <!-- VENDAS -->
                            <%
                                List<VendaEntidade> lstV = controle.ControladorVenda.pegarVendasDoUsuario(Logado.getIdUsuario());
                                if (lstV.size() == 0) {%>
                            <script>window.alert('Não há foi realizada nenhuma Venda!')
