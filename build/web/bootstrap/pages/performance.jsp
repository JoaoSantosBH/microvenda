...
<html lang="en">
    ...
    <body> 
        ...
        <div id="wrapper">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="panel-body">
                            <%
                            int x=0;
                                int totalVenda = ControladorUsuario.pegarTodasAsVendasDoUsuario(Logado.getIdUsuario());
                                int totalPedidos = ControladorUsuario.pegarTodosOsPedidosDoUsuario(Logado.getIdUsuario());
                                if(totalVenda !=0 && totalPedidos !=0){
                                     x = (totalVenda * 100) / totalPedidos;
                                } else {
                                     x =0;
                                }
            ...
            var vetorVindoJava = <%= util.PainelFinanceiroGoogleAPICharts.pegarPerformanceDeVendas(Logado.getIdUsuario())%>
            function drawChart() {
                var data = google.visualization.arrayToDataTable(vetorVindoJava);

                var options = {
                    title: 'Este foi o seu rendimento global!',
                    pieHole: 0.2,
                ...
                chart.draw(data, options);
                            ...
                            <%if (totalVenda == 0 || totalPedidos == 0) {%>
                            <script>window.alert('Ainda não foi feita nenhuma venda para medir a performance!')
                            ...
                            <div class="row show-grid">
                                <div class="col-md-3"  style="color: green;"><label>Total de vendas : </label></br> <%= totalVenda%></div>
                                <div class="col-md-3" style="color: blue;"><label>Total de Pedidos :</label></br> <%= totalPedidos%></div>

                                <% if (x <= 60) {%>
                                <div class="col-md-3" style="color: red;"><label>Sua performance foi de:</label></br><%= x%>% </div> 
                                <%} else {%>

                                <div class="col-md-3" style="color: green;"><label>Sua performance foi de :</label></br><%= x%>% </div>
                                <%}%>
