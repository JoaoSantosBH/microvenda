...
<%@page import="controle.ControladorVenda"%>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Venda Concluida</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">
                            ...
                            <%
                                ...
                                VendaEntidade venda = ControladorVenda.pegarVendaPeloId(Integer.valueOf(idVenda));
                                String formaPagamento = FormaPagamentoDAO.pegarFormaDePagamento(venda.getFormaPagamento());
                                ClienteEntidade cliente = ControladorCliente.pegarClientePeloId(pedido.getIdCliente());
                                String forma = FormaPagamentoDAO.pegarFormaDePagamento(venda.getFormaPagamento());
                            %>
                            <div class="panel panel-green">
                                <div class="panel-heading">
                                    Pedido [ <%= venda.getNumPedido()%>] Cliente : <%= cliente.getNome()%>
                                </div>
                                <div class="panel-body">

                                    <div class="row show-grid">

                                        <div class="col-md-2"><label>Data</label></br><%= fronteira.FormataDataHtml.formatarDataParaDisplay(venda.getData())%></div>
                                        <div class="col-md-2"><label>Valor</label></br>R$ <%= venda.getValor()%></div>
                                        <div class="col-md-2"><label>Parcelas</label></br><%= venda.getParcelas()%> </div>
                                        <div class="col-md-2"><label>Forma Pg</label></br><%= forma%></div>
                                        <div class="col-md-2"><label>Entrada</label> </br>R$ <%= venda.getEntrada()%></div>

                                    </div>

                                </div>
                                                                    <form action="hist_vendas_dia.jsp">
