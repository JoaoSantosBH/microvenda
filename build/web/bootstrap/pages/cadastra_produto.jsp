...
<html lang="en">
    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
            function validarCriaProduto() {
                var nome = formcriacliente.txt_nome_prod.value;
                if (nome === "") {
                    alert('Digite o nome do Produto a ser cadastrado');
                ...
                if (valor2 === "") {
                    alert('Digite o preço de VENDA do Produto! OBS: UTILIZE PONTO AO INVES DE VIRGULA!');
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Manter Produtos</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">
                            ...
                            %>
                            <form role="form" name="formcriacliente" method="post" action="InsereNovoProdutoServlet">
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" maxlength="150" placeholder="Nome Completo do Produto" name="txt_nome_prod" type="text" autofocus>
                                    </div>

                                    <div class="form-group">
                                        <textarea class="form-control" rows="3" maxlength="500" placeholder="Descricao do Produto" name="txt_descricao"   ></textarea>

                                    </div>

                                    <div class="form-group">
                                        <input class="form-control"  placeholder="Preço de Compra" name="txt_valor" type="number" >
                                    </div>

                                    <div class="form-group">
                                        <input class="form-control"  placeholder="Preço de Venda" name="txt_valor2" type="number" >
                                    </div>                                    

                                    <div class="form-group">
                                        <label>Linha à qual este produto pertence: </label>
                                    ...
                                    <input class="btn btn-lg btn-success btn-block" type="submit" value="Salvar Produto" onclick="return validarCriaProduto()">
                                ...
                                <script>
                                    window.alert('<%= request.getParameter("excep")%>');
                                </script>

                                <% } else if (Codmsg.equals("3")) {%>

                                <script>
                                    window.alert('Erro com o Banco de Dados! Tente mais tarde');
                                </script>
                                ...
                                <script>
                                    window.alert('Erro Inesperado! Tente Mais tarde');
                                </script>
                                <% } else if(Codmsg.equals("6")){ %>
                                                                <script>
                                    window.alert('Existe um ou mais pedidos com este Produto! Atenda ou apague o pedido primeiro');
                                </script>
                                <%}%>
                            ...
                            <form role="form" name="form_editar_prod" method="post" action="PreparaEditaProdutoServlet">

                                <fieldset> 

                                    <div class="form-group"><h3>Editar Produto</h3> </br>

                                        <label>Selecione o Produto que deseja editar</label>
                                        <select name="linhas" id="linhas">
                                        ...
                                        <input class="btn btn-warning btn-success btn-block" type="submit" value=" Editar Produto">
                            ...
                            <form role="form" name="form_excluir_prod" method="post" action="ExcluirProdutoServlet">

                                <fieldset> 

                                    <div class="form-group"><h3>Excluir Produto</h3> </br>
                                        <label> Selecione o Produto que deseja excluir  </label>
                                        <select name="produto_txt" id="linhas">
                                        ...
                                        <input type="hidden" name="id_usuario" value="<%= Logado.getIdUsuario() %>">
                                        <input class="btn  btn-danger btn-success btn-block" type="submit" value="Excluir Produto" onclick="return confirm('Tem Certeza que deseja Excluir o Produto?')">
                                    </div>
