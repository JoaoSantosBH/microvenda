                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="panel-body">
                            ...
                            <%
                                List<AreceberEntidade> ls = ControladorAReceber.pegarListaDeAReceberDeUmaVendaEspecifica(Integer.valueOf(idVenda), Logado.getIdUsuario());

                                if (ls.size() == 0) {%>
                            <script>window.alert('Esta Venda não possui parcelas a receber!')</script>
