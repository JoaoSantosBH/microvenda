...
<!--                                <fieldset>-->
                                    ...
                                    <div class="form-group">
                                        Nº  <input class="form-control" maxlength="5"  placeholder="Nº" name="txt_numero"  value="<%= e.getNumero()%>"  type="tel" >
                                    </div>
                                    <div class="form-group">
                                ...
                                <script>window.alert('Alteração de Cadastro Efetuada Com Sucesso!')</script>
