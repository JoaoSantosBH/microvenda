        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Pedidos Ativos Hoje</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">
                            ...
                            <%
                                List<PedidoEntidade> lsp = ControladorPedido.pegarTodosOsPedidosDoUsuarioDoDiaCorrente(Logado.getIdUsuario());
                                if (lsp.size() == 0) {
                            %>


                            <script>window.alert('Nenhum Pedido Ativo Nesta Data!')
