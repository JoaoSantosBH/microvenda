        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Buscar Venda</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">
                            ...
                            <!-- VENDAS -->
                            <%
                                List<VendaEntidade> lst = ControladorVenda.pegarListaDeVendasQueAtendemQueryLike(idUser, query);
                                if(lst.size() == 0){%>
                                <script>window.alert('Não foi encontrada nehuma venda com este numero!')</script>
                                ...
                                <%} else {
                                     ...
                                     for(VendaEntidade venda : lst){ %>
                                     <div class="form-group">
                                         <a href="hist_vendas_busca_pedido_numero.jsp?num=<%= venda.getNumPedido() %>" ><%= venda.getNumPedido() %></a>
                                     </div>    
