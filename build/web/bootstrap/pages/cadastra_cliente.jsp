                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" name="formcriacliente" method="post" action="CadastrarClienteServlet">
                                <!--<fieldset>-->
                                    <div class="form-group">
                                        <input class="form-control" maxlength="100" placeholder="Nome Completo" name="txt_nome" type="text" autofocus >
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" id="01" maxlength="9"  placeholder="Telefone Fixo" name="txt_tel_fixo" type="tel"  onKeyPress="MascaraTelefone(formcriacliente.txt_tel_fixo);" >
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" id="02"  maxlength="9"  placeholder="Celular" name="txt_cel" type="tel"  onKeyPress="MascaraTelefone(formcriacliente.txt_cel);" >
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" id="03"  maxlength="9"  placeholder="Outro Telefone" name="txt_tel_outro" type="tel"  onKeyPress="MascaraTelefone(formcriacliente.txt_tel_outro);" >
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" maxlength="9"  placeholder="CEP" name="txt_cep" type="text"  onKeyPress="MascaraCep(formcriacliente.txt_cep);" onblur="consultacep(this.value)">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" maxlength="150" id="logradouro" placeholder="Logradouro" name="txt_logradouro" type="text" >
                                    </div>

                                    <div class="form-group">
                                        <input class="form-control" maxlength="5"  placeholder="Nº" name="txt_numero" type="tel" >
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" maxlength="45"  placeholder="Complemento" name="txt_complemento" type="text" >
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" maxlength="45" id="bairro" placeholder="Bairro" name="txt_bairro" type="text" >
                                    </div>
                                    ...
                                    <input class="btn btn-lg btn-success btn-block" type="submit" value="Salvar" onclick="return validarCriaCliente()">
                                ...
                                <!--</fieldset>-->
                                    ...
                                    <script>window.alert('Cliente Cadastrado com Sucesso!')</script>
