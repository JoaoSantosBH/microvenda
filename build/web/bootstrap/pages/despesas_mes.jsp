        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <% List<DespesaEntidade> ls = ControladorDespesa.pegarTodasDespesasDoUsuarioDoMesCOrrente(Logado.getIdUsuario());
                                int total = 0;
                                for(DespesaEntidade d : ls){
                                    total += d.getValor();
                                }
                            %>
                            <h1 class="page-header">Despesas do mês R$ <%= total %>,00</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">
                            ...
                            <%
                                ...
                                if (ls.size() == 0) {%>
                            <script>window.alert('Nenhuma despesa este mês!')
