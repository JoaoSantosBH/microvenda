...
<html lang="en">
 ...
 <script language="javascript" type="text/javascript">
            function validarCliente() {
                ...
                if (linha === "0") {
                    alert('Selecione uma cliente para o Pedido');
                    formpedido.txt_id_cliente.focus();
                    return false;
                } else{
                    return confirm('Fechar Pedido?');
                }
            }
        </script>
                            ...
                            <div class="col-lg-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <!--  FECHAR PEDIDO  -->
                                        <form name="formpedido" method="post" action="FecharPedidoServlet"> 
                                        ...
                                        <% } %>
                                            ...
                                            <input type="hidden" name="id_usu" value="<%= Logado.getIdUsuario()%>">
                                            <input type="submit" class="btn-outline"  value="Gerar Pedido" onclick="return validarCliente()">
                                        </form >
                                        <!--  FECHAR PEDIDO  -->
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form role="form" name="form_carrinho[]" method="post" action="AdicionarItemCarrinhoServlet">
