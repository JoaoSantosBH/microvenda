        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Edita Linha de Produtos</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">

                            <%  LinhaEntidade l = LinhaDAO.pegarLinhaPeloId(Integer.parseInt(idLinha));
                                Boolean eMinhaLinha = LinhaDAO.verificarSeListaEhDoVendedor(idLinha, Logado.getIdUsuario());
                            %>
                            
                            <%  if(eMinhaLinha) {  %>
                            <form role="form" name="formcriacliente" method="post" action="EditaLinhaDeProdutosServlet">
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" maxlength="150" placeholder="<%= l.getNome()%>" name="txt_nome_linha" type="text" autofocus>
                                    </div>
                                    <input type="hidden" name="id_linha" value="<%= l.getIdLinha()%>">
                                    <input class="btn btn-lg btn-success btn-block" type="submit" value="Salvar Alterações " onclick="return validarCriaLinha()">
                                ...
                                <script>window.alert('Alterações Efetuadas com Sucesso!')</script>
                            ...
                            <form action="cadastra_linha.jsp">
