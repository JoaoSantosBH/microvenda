        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">SELECIONE O CLIENTE</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">
                            <% List<ClienteEntidade> lst = controle.ControladorCliente.pegarListaDeClientesDoVendedor(Logado.getIdUsuario()); %>
                            <form method="POST" action="BuscarTodosOsPedidosDoCLienteSelecionadoSevlet">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <input class="btn btn-lg btn-success btn-block" type="submit" value="Buscar" onclick="return confirm('Tem certeza que deseja buscar?')">
                                    </div>
                                </fieldset>
                            </form>
