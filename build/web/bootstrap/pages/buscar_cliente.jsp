                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="panel-body">
                            ...
                            <% List<ClienteEntidade> lst = ControladorCliente.buscarListaDeClientesQueAtendemQueryLike(idUsuario, query);
                            ...
                            <% if (lst != null) {%>
                               ...
                               <a href="listar_cliente.jsp?id=<%= c.getIdCliente() %>"><%= c.getNome() %></a>
                               </div>
                               <%}%>
