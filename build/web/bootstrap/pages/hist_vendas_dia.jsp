        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <% List<VendaEntidade> lstV = controle.ControladorVenda.pegarVendasDoUsuarioDoDiaAtual(Logado.getIdUsuario());
                                int totalVhj = 0;
                                for(VendaEntidade v : lstV){
                                    totalVhj+= v.getValor();
                                }
                            %>
                            <h1 class="page-header">Vendas Hoje - R$ <%= totalVhj %> reais</h1>
                            <% if(Codmsg.equals("2")) {%>   
                            <script>window.alert('Venda Excluida com sucesso!!')</script>
                                    <%}%>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="panel-body">
                            ...
                            <%
                                ...
                                if(lstV.size() == 0 ){%>
                                <script>window.alert('Não Foi Feita Nenhuma Venda Hoje!')
                            ...
                            <div class="panel panel-green">
                                ...
                                <div class="panel-body">
                                    <form method="POST" action="CancelarVendaExtornoServlet">
                                        <input type="submit" class="btn-danger" value="Extornar" onclick="return confirm('Tem certeza que deseja Cancelar esta venda??')">
                                        <input type="hidden" name="id_venda" value="<%= venda.getIdVenda() %>"> 
                                    </form>      
